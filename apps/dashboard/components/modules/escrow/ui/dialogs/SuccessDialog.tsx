...
export const SuccessResolveDisputeDialog = ({
  ...
  const platformFee = Number.parseFloat(escrow?.platformFee || "0");

  const parsedApproverFunds = Number.parseFloat(approverResolve || "0") || 0;
  const parsedReceiverFunds = Number.parseFloat(receiverResolve || "0") || 0;
